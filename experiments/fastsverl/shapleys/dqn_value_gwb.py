"""
Trains multiple prediction characteristic models for DQN agents in GWB environment.
"""
...
class ExpArgs:
    ...
    agent_args_f: str = None # Fill in wandb run name for GWB agent here.
    """where to load the agent's and the environment's hyperparameters from"""
    char_args_f: str = None # Fill in wandb run name for characteristic here.
    """where to load the characteristic's hyperparameters from"""
