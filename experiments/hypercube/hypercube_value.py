"""
Trains a DQN agent, prediction characteristic model, and Shapley model in the Hypercube environment.
...
class CharacteristicArgs(BaseSVERLArgs):
    char_class: str = "ValueCharacteristicModel"
...
class ShapleyArgs(BaseSVERLArgs):
    ...
    shapley_class: str = "ValueShapley"
