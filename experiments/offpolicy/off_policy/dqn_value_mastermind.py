"""
Trains off-policy prediction characteristic models in Mastermind environment.
"""
...
class ExpArgs:
    ...
    wandb_project_name: str = "FastSVERL-OffPolicy_NewLoss_Mastermind"
...
if __name__ == "__main__":
    ...
    # Buffered steady-state with importance sampling
